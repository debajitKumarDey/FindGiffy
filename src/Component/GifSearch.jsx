...
const GifSearch = () => {
  ...
  return (
    <div className='flex relative'>
      ...
      placeholder='Search for the GIFs and Stickers'
      className='w-full pl-4 pr-14 py-5 text-xl
       text-black rounded-tl rounded-bl border border-gray-300 outline-none ' />
{query &&(
  <button 
  onClick={()=>setQuery('')}
